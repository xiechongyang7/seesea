...
import com.seesea.seeseasms.model.dto.NetEaseSmsDto;
...
//        netEaseSmsDto.setNeedUp();
             ...
             * }
             */
            Assert.isNull(bytes,ResultCode.ER_1204,ResultCode.ER_1204_MSG);
            ...
            if(!(Const.SUCCESS.equals(String.valueOf(mapResult.get("code"))))){
                Assert.isNullStr(mapResult.get("code"),ResultCode.ER_1205,ResultCode.ER_1205_MSG);
